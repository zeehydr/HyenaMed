...
train_pipeline = [
    ...
    dict(type='LoadAnnotations', reduce_zero_label=False), # changed by me
    dict(
        type='RandomResize',
        # scale=(256, 256), #for DDRNet 
        scale=(1024, 256),
        
        
        ratio_range=(0.5, 2.0),
        # keep_ratio=False), # for DDRNet and lraspp
        keep_ratio=True),
...
tta_pipeline = [
    ...
    dict(
        ...
        transforms=[
            [
                # dict(type='Resize', scale_factor=r, keep_ratio=False) # for DDRNet and lraspp
